...
public class AboutCinemaSuiteWindow : EditorWindow
{
    ...
    const string CMF_THANKS = "Cinema Suite Inc. extends a special thank you to the Canada Media Fund (CMF) for assistance in making Cinema Suite possible. To Tim McDaniel for all his excellent contributions to Cinema Director.";
    #endregion
    ...
    public void Awake()
    {
        ...
        cmfLogo = Resources.Load("CS_CMF") as Texture2D;
        if (cmfLogo == null)
        {
            UnityEngine.Debug.LogWarning("CS_CMF.jpg missing from the Cinema Suite/About/Resources folder.");
        }

        facebookLogo = Resources.Load("CS_Facebook") as Texture2D;
        if (facebookLogo == null)
        {
            UnityEngine.Debug.LogWarning("CS_Facebook.png missing from the Cinema Suite/About/Resources folder.");
        }

        twitterLogo = Resources.Load("CS_Twitter") as Texture2D;
        if (twitterLogo == null)
        {
            UnityEngine.Debug.LogWarning("CS_Twitter.png missing from the Cinema Suite/About/Resources folder.");
        }

        youtubeLogo = Resources.Load("CS_YouTube") as Texture2D;
        if (youtubeLogo == null)
        {
            UnityEngine.Debug.LogWarning("CS_YouTube.png missing from the Cinema Suite/About/Resources folder.");
        }
